...
| B06 | "All prompts should be editable. Requests monitorable." | [#8](https://github.com/elpideus/demido-studio/issues/8), [#33](https://github.com/elpideus/demido-studio/issues/33) | `src-tauri/crates/demido-prompts/`, and the log half of monitorable in `src-tauri/crates/demido-trace/`: the Session Monitor is a window that defers, the record it would read is not | - |
