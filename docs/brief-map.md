...
| B15 | "Tool calling and custom tools" | [#14](https://github.com/elpideus/demido-studio/issues/14), [#20](https://github.com/elpideus/demido-studio/issues/20) | `src-tauri/crates/demido-tools/`: the trait, the registry and the Files group, every path confined to a workspace. Callable from Rust and offered to nobody: `run_command` is [#51](https://github.com/elpideus/demido-studio/issues/51), the payload is [#54](https://github.com/elpideus/demido-studio/issues/54) | - |
