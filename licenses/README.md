...
Every third party whose code, binary or asset ships with or is fetched by Demido Studio has its
license reproduced here, at `licenses/<owner>/<project>/LICENSE`.
