...
> Current version: **v0.6.1** (pre-release). Download links below go directly to the installer for your platform.

### Windows

| Your PC | Recommended installer | Alternative |
|---|---|---|
| Most laptops & desktops (Intel / AMD) | [Download installer (.exe)](https://github.com/elpideus/demido-studio/releases/download/v0.6.1/Demido.Studio_0.6.1_x64-setup.exe) | [MSI](https://github.com/elpideus/demido-studio/releases/download/v0.6.1/Demido.Studio_0.6.1_x64_en-US.msi) · [Portable .exe](https://github.com/elpideus/demido-studio/releases/download/v0.6.1/Demido.Studio_v0.6.1_windows_x64_portable.exe) |
| ARM-based (Surface Pro X, Snapdragon) | [Download installer (.exe)](https://github.com/elpideus/demido-studio/releases/download/v0.6.1/Demido.Studio_0.6.1_arm64-setup.exe) | [MSI](https://github.com/elpideus/demido-studio/releases/download/v0.6.1/Demido.Studio_0.6.1_arm64_en-US.msi) · [Portable .exe](https://github.com/elpideus/demido-studio/releases/download/v0.6.1/Demido.Studio_v0.6.1_windows_arm64_portable.exe) |
...
| Your Mac | Download |
|---|---|
| Apple Silicon (M1 / M2 / M3 / M4) | [Download .dmg](https://github.com/elpideus/demido-studio/releases/download/v0.6.1/Demido.Studio_0.6.1_aarch64.dmg) |
| Intel or unsure | [Download Universal .dmg](https://github.com/elpideus/demido-studio/releases/download/v0.6.1/Demido.Studio_0.6.1_universal.dmg) |
...
|---|---|---|
| Ubuntu / Debian / Mint (x86_64) | [.deb](https://github.com/elpideus/demido-studio/releases/download/v0.6.1/Demido.Studio_0.6.1_amd64.deb) | [AppImage](https://github.com/elpideus/demido-studio/releases/download/v0.6.1/Demido.Studio_0.6.1_amd64.AppImage) · [.rpm](https://github.com/elpideus/demido-studio/releases/download/v0.6.1/Demido.Studio-0.6.1-1.x86_64.rpm) |
| Fedora / openSUSE / RHEL (x86_64) | [.rpm](https://github.com/elpideus/demido-studio/releases/download/v0.6.1/Demido.Studio-0.6.1-1.x86_64.rpm) | [AppImage](https://github.com/elpideus/demido-studio/releases/download/v0.6.1/Demido.Studio_0.6.1_amd64.AppImage) |
| Any distro (x86_64, no install) | [AppImage](https://github.com/elpideus/demido-studio/releases/download/v0.6.1/Demido.Studio_0.6.1_amd64.AppImage) | — |
| Raspberry Pi / ARM64 | [.deb](https://github.com/elpideus/demido-studio/releases/download/v0.6.1/Demido.Studio_0.6.1_arm64.deb) | [.rpm](https://github.com/elpideus/demido-studio/releases/download/v0.6.1/Demido.Studio-0.6.1-1.aarch64.rpm) |
| ARMv7 (older Raspberry Pi) | [.deb](https://github.com/elpideus/demido-studio/releases/download/v0.6.1/Demido.Studio_0.6.1_armhf.deb) | — |

**AppImage** — make executable and run:
```bash
chmod +x Demido.Studio_0.6.1_amd64.AppImage
./Demido.Studio_0.6.1_amd64.AppImage
```

**Deb package:**
```bash
sudo dpkg -i Demido.Studio_0.6.1_amd64.deb
```

**RPM package:**
```bash
sudo rpm -i Demido.Studio-0.6.1-1.x86_64.rpm
```
...
Demido Studio is **pre-release** (`v0.6.1`). The core functionality is stable and used daily, but the public API (IPC commands, store shapes) may change before `v1.0`. Feedback and contributions are very welcome.
