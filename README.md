...
Demido Studio is **pre-release** (`v0.1.0`). The core functionality is stable and used daily, but the public API (IPC commands, store shapes) may change before `v1.0`. Feedback and contributions are very welcome.
